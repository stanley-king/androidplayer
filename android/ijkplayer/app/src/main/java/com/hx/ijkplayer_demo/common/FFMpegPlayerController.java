...
public class FFMpegPlayerController //implements IMediaPlayback
{
    /**
    ...
    public FFMpegPlayerController(final Activity activity, int viewid)
    {
        mVideoView = (IjkVideoView) activity.findViewById(viewid);
...
//            $.id(R.id.app_video_loading).visible();
     ...
     * @return
     */
    public boolean ismPlayerSupport() {
        return mPlayerSupport;
    }
    ...
    public FFMpegPlayerController playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        return this;
    ...
    public FFMpegPlayerController onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public FFMpegPlayerController onComplete(OnCompleteListener onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public FFMpegPlayerController onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public FFMpegPlayerController onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public FFMpegPlayerController live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public FFMpegPlayerController toggleAspectRatio(){
        if (mVideoView != null) {
            mVideoView.toggleAspectRatio();
        }
        return this;
